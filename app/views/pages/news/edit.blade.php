                        ...
                        <div class='col-md-10'>
                            <div class='box box'>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-xs-4">
                                                ...
                                                {{ Form::text('news_date', $news->news_date, ['id' => 'news_date' , 'class' => 'form-control datepicker date-mask','data-date-format' => 'dd/mm/yyyy', 'placeholder' => 'Clique aqui para escolher uma data (dia/mes/ano)']) }}
                                ...
                                <div class="box-footer">
                                    <div class="form-group">
                                        {{ Form::submit('Atualizar Mensagem', ['class' => 'btn btn-success btn-lg btn-block']) }}
                                    </div>
                                </div>
                            </div><!-- /.box -->
                        </div><!-- /.col-->
