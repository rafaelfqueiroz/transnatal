                                            ...
                                            <div class="box">
                                                ...
                                                <div class="box-body">
                                					...
                                					<div class="form-group">
                                                        ...
                                                        {{ Form::text('birthday', $client->birthday, ['id' => 'clientBirthday' , 'class' => 'form-control datepicker date-mask','data-date-format' => 'yyyy-mm-dd', 'placeholder' => 'Clique aqui para escolher uma data (dia/mes/ano)', 'required' => 'required']) }}
